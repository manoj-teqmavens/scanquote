 ...
 * ItemsmarkupFixture
 */
class ItemsmarkupFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'markup' => ['type' => 'string', 'length' => 60, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2021-10-04 12:57:40',
                'modified' => '2021-10-04 12:57:40',
            ],
        ];
        parent::init();
    }
